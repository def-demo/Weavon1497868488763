...
public class Beneficiary  {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, flag, city, clientname, mmid, accountnumber, relationshipid, branch, beneficiarymobilenumber, remitterid, bank, bcagent, beneficiaryname, sessiontoken, id, id, beneficiaryemailid, state, ifsccode, status);
  }
