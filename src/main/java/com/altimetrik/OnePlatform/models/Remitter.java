...
public class Remitter  {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(pincode, remitter.pincode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pincode, remitteraddress2, remitteraddress1, idproofissueplace, lcityname, idproofnumber, clientname, idproof, lremitteraddress, remittername, idproofissuedate, remittermobilenumber, bcagent, cityname, lpincode, lstatename, statename, sessiontoken, alternatenumber, id, id, addressproof, idproofexpirydate, status);
  }
